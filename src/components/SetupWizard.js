...
export const SetupWizard = () => {
    ...
    const steps = [
        {
            ...
            icon: _jsx(Database, { size: 48, color: "var(--primary)" }),
        ...
        },
        {
            ...
            icon: _jsx(BrainCircuit, { size: 48, color: "var(--primary)" }),
        ...
        },
        {
            ...
            icon: _jsx(Shield, { size: 48, color: "var(--primary)" }),
    ...
    return (_jsxs("div", { className: "wizard-overlay", children: [_jsxs(motion.div, { className: "wizard-card", initial: { opacity: 0, scale: 0.9, y: 20 }, animate: { opacity: 1, scale: 1, y: 0 }, transition: { type: "spring", damping: 25, stiffness: 300 }, children: [_jsx("div", { className: "wizard-progress", children: steps.map((_, i) => (_jsx("div", { className: `progress-dot ${i === step ? 'active' : ''}` }, i))) }), _jsx(AnimatePresence, { mode: "wait", children: _jsxs(motion.div, { initial: { opacity: 0, x: 20 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: -20 }, transition: { duration: 0.2 }, className: "wizard-content", children: [_jsx("div", { className: "wizard-icon-wrapper", children: steps[step]?.icon }), _jsx("h2", { children: steps[step]?.title }), _jsx("h4", { children: steps[step]?.description }), _jsx("p", { children: steps[step]?.content })] }, step) }), _jsxs("button", { className: "wizard-btn", onClick: nextStep, children: [step === steps.length - 1 ? 'Get Started' : 'Next', _jsx(ChevronRight, { size: 20 })] })] }), _jsx("style", { children: `
        .wizard-overlay {
          position: fixed;
          inset: 0;
